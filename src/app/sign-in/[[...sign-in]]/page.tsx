...
import { Connection, Field, FieldError, Input, Label } from "@clerk/elements/common";
                ...
                <Root>
                    ...
                    <Step name="start">
                        <Field name="identifier" className="flex flex-col gap-2">
                            <Input placeholder="Email or Username" className="w-72 py-2 px-6 rounded-full text-background placeholder:text-sm" />
                            <FieldError className="text-red-600 text-sm" />
                        </Field>
                        <Action submit className="w-72 mt-4 text-sm text-center text-iconBlue underline">Continue</Action>
                    </Step>
                    <Step name="verifications">
                        <Strategy name="password">
                            ...
                            <div className="flex flex-col gap-2">
                                <Action submit className="w-72 mt-4 text-sm text-center text-iconBlue underline">Sign In</Action>
                                <Action navigate="forgot-password"
                                    className="w-72 mt-2 text-sm text-center underline">Forgot Password</Action>
                            </div>
                        </Strategy>
                        <Strategy name="reset_password_email_code">
                            <p className="text-sm mb-2">
                                We sent a code to <SafeIdentifier />
                            </p>
                            <Field name="code" className="flex flex-col gap-2">
                                <Input className="w-72 py-2 px-6 rounded-full text-background placeholder:text-sm" />
                                <FieldError className="text-red-600 text-sm" />
                            </Field>
                            <Action submit className="w-72 mt-2 text-sm text-center text-iconBlue underline">Verify</Action>
                        </Strategy>
                    </Step>
                    <Step name="forgot-password" className="flex justify-between w-72 text-sm">
                        <SupportedStrategy name="reset_password_email_code">
                            <span className="text-sm text-iconBlue underline">Reset Password</span>
                        </SupportedStrategy>
                        <Action navigate="previous" className="text-sm underline">Go back</Action>
                    </Step>
                    <Step name="reset-password">
                        ...
                        <Action submit>Reset Password</Action>
                    </Step>
                    <div className="w-72 flex items-center gap-4">
                        <div className="flex-grow h-px border border-textGray"></div>
                    ...
                    <Link href={"/sign-up"} className="w-72 p-2 text-foreground text-center font-bold bg-iconBlue rounded-full">Create An Account</Link>
